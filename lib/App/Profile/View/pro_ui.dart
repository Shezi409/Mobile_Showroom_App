      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            itemProfile('Name', 'Shahzad Aslam', CupertinoIcons.person),
            const SizedBox(height: 10),
            itemProfile('Phone', '03343455557', CupertinoIcons.phone),
            const SizedBox(height: 10),
            itemProfile(
                'Address', 'abc address, xyz city', CupertinoIcons.location),
            const SizedBox(height: 10),
            itemProfile('Email', 'jamdeveloper@gmail.com', CupertinoIcons.mail),
            const SizedBox(
              height: 20,
            ),
            SizedBox(
